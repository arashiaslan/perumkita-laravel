...
@section('content')
    <div class="card shadow-lg mx-4 card-profile-bottom">
        <div class="container-fluid py-4">
                <form action="{{ route('admin.galeri.update', $gallery->id) }}') }}" method="POST" enctype="multipart/form-data" class="">
                    @csrf
                    @method('PUT')
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <h2 class="my-3">Edit Foto</h2>
                            <button class="btn btn-primary btn-sm ms-auto" type="submit">Ubah</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mt-3">
                                    <p>Gambar Saat Ini:</p>
                                    <img src="{{ asset($gallery->image) }}" alt="Current Image" style="max-height: 400px;">
                                </div>
                            </div>
                        </div>
                    </div>
