            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        ...
                        <a href="" class="btn btn-primary text-xxs">Tambah Artikel</a>
                    </div>
                                    ...
                                    @foreach ($menus as $menu)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ $menu->price }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                            ...
                                            <td class="align-middle">
                                                ...
                                                |
                                                <form id="delete-form-{{ $menu->id }}" action="" method="post"
